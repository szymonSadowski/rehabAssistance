...
"")
        ...
        self.frameTrain = QtWidgets.QFrame(self.trainPage)
        self.frameTrain.setGeometry(QtCore.QRect(190, 10, 481, 381))
...
"")
        ...
        self.frameRecord = QtWidgets.QFrame(self.recordPage)
        self.frameRecord.setGeometry(QtCore.QRect(200, 20, 481, 381))
        self.frameRecord.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frameRecord.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frameRecord.setObjectName("frameRecord")
